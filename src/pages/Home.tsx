...
const capabilities = [
  {
    ...
    description: "Process, mechanical, piping, electrical, controls",
    link: "/services",
  },
  {
    icon: ShoppingCart,
    title: "Procurement",
    description: "Strategic sourcing, materials, logistics",
    link: "/services",
  },
  {
    icon: Factory,
    title: "Fabrication",
    description: "Shop-built modules and assemblies",
    link: "/services",
  },
  {
    icon: HardHat,
    title: "Construction",
    description: "Field execution and commissioning",
    link: "/services",
  },
  {
    icon: Wrench,
    title: "Maintenance",
    description: "Turnarounds and reliability",
    link: "/services",
  },
  {
    icon: Zap,
...
export default function Home({ onNavigate }: HomeProps) {
  ...
  return (
    <div className="min-h-screen">
      <section
        ref={heroRef}
        className="relative min-h-screen flex items-center geo-pattern overflow-hidden"
      >
        <HomePageHero />
      </section>
      ...
      <section className="py-12 bg-white border-y border-slate-100">
        <div className="section-padding mb-6">
          <p className="label-premium text-center">
        ...
        <div className="section-padding">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="stat-card bg-white rounded-2xl p-6 shadow-sm border border-slate-100 text-center hover:shadow-lg hover:-translate-y-1 transition-all"
              >
        ...
        <div className="section-padding">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-slate-600">
              From concept to commissioning: engineering, procurement,
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {capabilities.map((cap, index) => (
              <button
                key={index}
                onClick={() => handleNavigate(cap.link)}
                className="service-card card-premium p-6 text-left group"
              >
            ...
            {projects.map((project) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-2">
                  <span className="px-3 py-1 bg-sky-50 text-sky-600 text-xs font-semibold uppercase tracking-wider rounded-full">
                    {project.category}
                  </span>
        ...
        <div className="section-padding relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-slate-400 text-lg mb-8">
              Let's discuss how GLY Engineering can help deliver your project
              with excellence.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <button
                ...
                className="px-6 py-3.5 border border-white/20 text-white font-medium rounded-full hover:bg-white/10 transition-colors"
              >
                Join Our Team
              </button>
            </div>
